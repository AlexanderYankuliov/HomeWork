...
class ThirdViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        view.backgroundColor = UIColor(red: 0.3, green: 0.5, blue: 0.3, alpha: 1)
    ...
    @objc private func nextVC() {
        ...
        let viewController = storyboard.instantiateViewController(identifier: "FourthViewController") as! FourthViewController
    ...
    private func makeButton() -> UIButton {
        ...
        button.setTitle("Tap to fourth ViewController", for: .normal)
